module ACC64_tb();
    ...
    string filename_y = "../Simple_DSP_Core_MATLAB/Image_Reconstruction/Matlab Vars/y_sign_fi.txt";
    string filename_z = "../Simple_DSP_Core_MATLAB/Image_Reconstruction/Matlab Vars/Z.txt";
    int passed , failed;
